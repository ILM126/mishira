...
void WindowLayer::initializeResources(GraphicsContext *gfx)
{
	appLog(LOG_CAT)
...
void WindowLayer::updateResources(GraphicsContext *gfx)
{
...
void WindowLayer::destroyResources(GraphicsContext *gfx)
{
	appLog(LOG_CAT)
