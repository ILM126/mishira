...
// release without skipping any numbers. E.g. "-alpha1" is "0", "-rc1" is "0",
// "-rc2" is "1" and final is "2". If there is no PUBLIC pre-releases then the
// final would be "0".
#define ORG_NAME "Mishira"
#define APP_NAME "Mishira"
#define APP_VER_STR "1.1.0-alpha1"
